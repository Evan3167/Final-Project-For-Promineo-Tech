package Invoice_Project.errorHandler;
...
public class GlobalErrorHandler {
  ...
  public Map<String, Object> handeMethodArgumentTypeMismatchException(
      MethodArgumentTypeMismatchException e, WebRequest webRequest){
    return createExceptionMessage(
        e, HttpStatus.BAD_REQUEST, webRequest, LogStatus.MESSAGE_ONLY);
  }
